    ...
    static func newWindow(
        ...
        c.scheduleInitialPresentation {
            ...
            guard
                ...
                let parent,
                !(c.derivedConfig.windowPositionX != nil && c.derivedConfig.windowPositionY != nil)
            else {
                return
            }
            ...
            DispatchQueue.main.async {
                window.cascadeTopLeft(from: parent.topLeftForNextWindow())
            }
        }
    ...
    static func newTab(
        ...
        controller.scheduleInitialPresentation {
            ...
            guard
                ...
                !(controller.derivedConfig.windowPositionX != nil && controller.derivedConfig.windowPositionY != nil)
            else {
                return
            }
