...
typedef union {
  ...
  // `linux` collides with preprocessor-defined identifiers on some toolchains.
  ghostty_platform_linux_s linux_;
} ghostty_platform_u;
...
void ghostty_surface_set_linux_gtk_gl_area(ghostty_surface_t, void*);
