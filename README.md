...
**Ghostty** is a cutting-edge, cross-platform, GPU-accelerated terminal emulator.
Compliant with standards, it also boasts modern, non-standard features to
empower CLI developers in building feature rich, interactive applications.

**Project Status:** While still in beta, **Ghostty** already implements most
features you'd expect for a daily driver and is being used by hundreds of
beta users. See [Roadmap and Status](#roadmap-and-status) for more.
