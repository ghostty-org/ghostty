...
pub const Tab = extern struct {
    ...
    const Private = struct {
        ...
        /// The override title for this tab. When set, this takes precedence
        /// over the terminal title and surface title override.
    ...
    /// Prompt for a manual title change for the tab.
    ...
    /// Set the title override for this tab.
    ...
    fn closureComputedTitle(
        ...
        // Our plain title is the tab override if set, otherwise the surface
        // override if set, otherwise the terminal title if it exists,
        // otherwise a default string. Tab override has highest priority.
        const plain = plain: {
