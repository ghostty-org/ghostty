...
pub const kitty_graphics_unicode_placement_iterator_new = kitty_graphics.unicode_placement_iterator_new;
pub const kitty_graphics_unicode_placement_iterator_free = kitty_graphics.unicode_placement_iterator_free;
pub const kitty_graphics_unicode_placement_next = kitty_graphics.unicode_placement_iterator_next;
pub const kitty_graphics_unicode_placement_get = kitty_graphics.unicode_placement_get;
pub const kitty_graphics_unicode_placement_get_multi = kitty_graphics.unicode_placement_get_multi;
pub const kitty_graphics_unicode_placement_render_info = kitty_graphics.unicode_placement_render_info;
