...
const type_decls = [_]TypeDecl{
    ...
    .initStruct("GhosttyKittyGraphicsUnicodePlacementRenderInfo", kitty_graphics.UnicodePlacementRenderInfo),
    ...
    .initEnum("GhosttyKittyGraphicsUnicodePlacementData", kitty_graphics.UnicodePlacementData, "GHOSTTY_KITTY_GRAPHICS_UNICODE_PLACEMENT_DATA_"),
    ...
    .initOpaque("GhosttyKittyGraphicsUnicodePlacementIterator"),
