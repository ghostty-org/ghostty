...
pub const StreamHandler = struct {
    ...
    // command menu below, the protocol log, and the command prompt. Each
    // tmux pane gets its own follower surface, driven from the app
    // thread. See TmuxSession for that side of things.
