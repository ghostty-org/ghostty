...
///   * `copy-and-paste` - Depending on the current selection:
///         * Some text selected: Copy the selected text to the clipboard.
///         * No selection: Paste the contents of the clipboard.
