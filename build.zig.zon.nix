...
in
  linkFarm name [
    ...
    {
      name = "zig_objc-0.0.0-Ir_Sp6YTAQBkxwpOIbn8O3sMtioJjCN1PoOuaMwx-sOZ";
      path = fetchZigArtifact {
        name = "zig_objc";
        url = "https://github.com/pluiedev/zig-objc/archive/e2d4d08d75784f1c4055bb3dec4a2a21a49d0cf4.tar.gz";
        hash = "sha256-DziZStUd0x53QrXHRDtkBi3SfFf3G3HL1qVuVK6OJfI=";
      };
    }
    {
