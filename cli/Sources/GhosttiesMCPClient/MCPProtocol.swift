...
// `JSONValue` is defined in GhosttiesCore so the server and client share one
// source of truth for JSON-RPC payload shapes (Fragile Area #14 — three-surface
// schema coherence). Don't redeclare it here.
